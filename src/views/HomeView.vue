  ...
  <div class="container">
    <div class="content">
      <div class="square twitch" style="margin-bottom: 50px">
        ...
        <div class="circle">
          <h2 class="DrugRadar">Humour&nbsp;Club</h2>
          <p>Spread joy and rate people's homour</p>
        </div>
      </div>

      <a href="{{route('dashboard.index')}}" class="button" target="_parent">
        <span class="actual-text">&nbsp;Humour&nbsp;Detector</span>
        <span class="hover-text" aria-hidden="true">&nbsp;Humour&nbsp;Detector</span>
      </a>
    </div>
  </div>
</template>
